							...
							<td colspan="10"><input id="buscar" name="buscar" type="text" class="form-control" placeholder="Busqueda"/>
								<table class="table" id="tablacontenido" style="border: thin; border-color: #B53739" width="75%">
									...
									<tbody>
										...
										<tr onClick="window.open('http://ec2-18-191-142-38.us-east-2.compute.amazonaws.com/ahorcado/Ahorcado.php/?id=<?= base64_encode($actividadesDisponibles [$i] ["id"] );?>&username=<?= base64_encode($cedulaUser); ?>&course=<?= base64_encode( $actividadesDisponibles [$i] ["course"] ); ?>')">
