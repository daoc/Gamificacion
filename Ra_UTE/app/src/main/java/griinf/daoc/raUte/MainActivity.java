    ...
    class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                //Texture texture = new Texture(BitmapHelper.rescale(BitmapHelper.convert(getResources().getDrawable(R.drawable.pokeball)), 512, 512));
                ...
                cube = loadModel(R.raw.charizard, 0.5f, mOBJ);
                //cube = loadModel(R.raw.pokeball, (float) 0.1, m3DS);
                //cube = loadModel("res/raw/monster.3ds", (float) 0.5, m3DS);
        ...
        private Object3D loadModel(int ressource, float scale, int type) {
            InputStream stream = getResources().openRawResource(ressource);
